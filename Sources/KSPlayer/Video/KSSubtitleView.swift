...
public class SrtListCell: UITableViewCell {
    ...
    override public init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        localIconView.setBackgroundImage(UIImage(systemName: "rectangle"), for: .normal)
        localIconView.setBackgroundImage(UIImage(systemName: "rectangle")?.withTintColor(.blue), for: .selected)
